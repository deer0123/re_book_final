![스크린샷 2024-12-09 164515](https://github.com/user-attachments/assets/b4683eaa-7b1b-485d-a330-ffe456a57757)# 최종 ReBook(중간 Book4W) 도서 리뷰 웹사이트 프로젝트
...
---
## 2. 개발 이력
### 2.1. 개발 기간: 2024-10-21 ~ 2024-10-30 (중간), 2024-12-05 ~ 2024-12-09 (최종)
### 2.2. 팀원
...
### 7.4. 김성철
>#### 7.4.1. 최종
>- 최종 프로젝트는 중간 프로젝트를 기반으로 JSP를 React로 전환하였고, AWS와 도커를 활용한 배포와 Github Actions를 통한 자동화를 구현하였습니다. 이로써 중간과 최종 프로젝트를 통해 개발의 전 과정을 경험하였습니다.
